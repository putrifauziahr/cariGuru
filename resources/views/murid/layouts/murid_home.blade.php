        ...
        <div class="header-area">
            <div class="container">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="logo">
                            <a href="{{url ('/cariguru.com')}}">
                                Cari<span style="color: white;">Guru.com</span>
                        ...
                        <div class="main-menu">
                            ...
                            <div class="collapse navbar-collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    <li><a href="{{url ('/dashboard_murid')}}">Dashboard</a></li>
                                    <li><a href="{{url ('/murid_home_guru')}}">Guru</a></li>
                                    <li><a href="#pack">Tentang Aplikasi</a></li>
                                    <!--/.project-btn-->
                                </ul>
                            </div><!-- /.navbar-collapse -->
                        </div><!-- /.main-menu-->
