    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" action="/guru/editBiodata" method="POST">
                            {{csrf_field()}}
                            @foreach($tampilkan_data as $a )
                            <div class="form-group">
                                <label class="col-md-12 mb-0">Pekerjaan</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control pl-0 form-control-line" name="keahlian" value="{{ $a->id_user}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-12 mb-0">Kualifikasi / Bidang</label>
                                <div class="col-md-12">
