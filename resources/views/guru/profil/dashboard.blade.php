...
@section('title', 'Guru CariGuru.com')
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Murid Les</h5>
                        <h2><span class="counter">1</span> <span class="tuition-fees">Murid Les</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        ...
                        <!-- <h2>Bintang<span class="counter">5</span> <span class="tuition-fees">Rating</span></h2> -->
