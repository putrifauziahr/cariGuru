                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    ...
                                    <button type="button" class="btn btn-custom" style="color: white">Gabung Sekarang</button>
                                </div>
                                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        <h2 style="color: #154360">Category</h2>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        <!--features_items-->
                        <h2 class="title text-center" style="color: #154360">Features Items</h2>
                        <div class="col-sm-4">
