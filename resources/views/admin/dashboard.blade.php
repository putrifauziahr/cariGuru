...
@section('title', 'Admin CariGuru.com')
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Guru</h5>
                        <h2><span class="counter">1</span> <span class="tuition-fees">Guru</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Murid</h5>
                        <h2><span class="counter">1</span> <span class="tuition-fees">Murid</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Les</h5>
                        <h2><span class="counter">1</span> <span class="tuition-fees">Les</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Admin</h5>
                        <h2><span class="counter">1</span> <span class="tuition-fees">Admin</span></h2>
